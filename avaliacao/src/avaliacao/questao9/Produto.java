...
public class Produto     {
	...
	public static void autoGenerate(ProdutoDAO dao) throws SQLException {
		...
		for (int i = 0; i<3; i++) {
			int randomId = random.nextInt(1);
			double randomDesconto= random.nextDouble();
			if(!dao.validarId(randomId)) {
				...
				System.out.println("ID repetido na geração automática de produtos"+ "(" +"ID:" +randomId + "), criando novamente...");
				i--;
			}
		}
	}
